/** 
** The contract domain class includes all of the columns that match the database along with the getter and setter methods, and the to string method
...
public class Contract {
	...
	@Column(name = "Fax")
	//@Pattern(regexp = "([0-9])", message = "Fax number must be numerical")
	private String fax;
